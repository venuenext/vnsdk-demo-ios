...
///
- (void)trackUserId:(NSString * _Nonnull)id;
...
///
- (void)trackCompletedPurchaseWithOrderId:(NSString * _Nonnull)orderId quantity:(NSInteger)quantity discount:(double)discount tips:(double)tips tax:(double)tax total:(double)total paymentTypes:(NSString * _Nullable)paymentTypes;
...
///
- (void)initialize:(NSString * _Nonnull)org;
/// Initialize the SDK with your OrderNext assigned Organization name and Environment
/// \param org Ordernext Organization Name
///
/// \param env Ordernext Environment Name
///
- (void)initialize:(NSString * _Nonnull)org env:(NSString * _Nonnull)env;
/// Configure the Braintree Payment Processor for credit card processing
/// without Apple Pay functionality
- (void)configureBrainTree:(id <PaymentProcessable> _Nonnull)processor;
/// Initialize the SDK with your OrderNext assigned domain
/// (Primarily used for development purposes)
/// \param domain OrderNext Base URL
///
- (void)initializeWithDomain:(NSString * _Nonnull)domain;
